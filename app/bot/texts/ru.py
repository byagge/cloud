...
TEXTS = {
    ...
    "agent_ai_ask": (
        "🤖 <b>ИИ: правки существующего проекта</b>\n\n"
        "Опишите, что сломалось (можно фото).\n"
        "Сначала анализ и план — запись на сервер только после вашего «Работать по плану».\n"
        "Только патчи существующих проектов — минимальные правки + бэкапы.\n\n"
        "Во время работы будет кнопка <b>Стоп</b>."
    ),
